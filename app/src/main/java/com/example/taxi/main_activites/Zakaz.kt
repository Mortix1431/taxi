...
class Zakaz : AppCompatActivity() {
    ...
    lateinit var searchSessionListener: Session.SearchListener
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        polylineObject.apply {
            strokeWidth = 5f
            setStrokeColor(ContextCompat.getColor(this@Zakaz, R.color.grey))
            outlineWidth = 1f
            outlineColor = ContextCompat.getColor(this@Zakaz, R.color.black)
        }
        ...
        searchSessionListener = object : Session.SearchListener {//SearchSessionListener
